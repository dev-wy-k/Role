...
class ProfileController extends Controller
{
    ...
    public function changeName(Request $request){
        ...
        return redirect()->route("profile.edit.name.email")->with("toast", ["icon"=>"success", "title"=>"Name Updated"])  ;
    }
    ...
    public function changePhoto(Request $request){
        ...
        return redirect()->route('profile')->with("toast", ["icon"=>"success", "title"=>"Photo Updated"])  ;
    }
    ...
    public function updateInfo(Request $request){
        ...
        return redirect()->route("profile.edit.name.email")->with("toast", ["icon"=>"success", "title"=>"Information Updated"]) ;
    }
}
